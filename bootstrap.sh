...
puppet module install --modulepath=/root/bootstrap/modules abstractit/puppet --version 2.1.2
...
puppet module install --modulepath=/root/bootstrap/modules puppetlabs/puppetdb
